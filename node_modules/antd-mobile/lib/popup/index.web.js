...
function create(instanceId, config, content) {
    ...
    _reactDom2["default"].render(_react2["default"].createElement(_rcDialog2["default"], { prefixCls: prefixCls, visible: true, title: "", footer: "", className: prefixCls + '-' + animationType, transitionName: transitionName || transName, maskTransitionName: maskTransitionName || 'am-fade', onClose: close, maskClosable: maskClosable, wrapProps: props.wrapProps || {} }, content), div);
    return {
