...
var MIndexedList = function (_React$Component) {
    ...
    MIndexedList.prototype.render = function render() {
        ...
        return _react2["default"].createElement(IndexedList, __assign({ sectionHeaderClassName: "am-indexed-list-section-header am-list-body", sectionBodyClassName: "am-indexed-list-section-body am-list-body" }, restProps, extraProps), this.props.children);
    };
