...
var ButtonListItem = function (_React$Component) {
    ...
    ButtonListItem.prototype.render = function render() {
        var _splitObject = (0, _splitObject4["default"])(this.props, ['children', 'className', 'prefixCls', 'onClick', 'touchFeedback', 'activeStyle']),
        ...
        return _react2["default"].createElement("div", __assign({}, restProps, { style: style, className: touchFeedback ? className + ' ' + prefixCls + '-active' : '' + className, onClick: onClick }), children);
    };
