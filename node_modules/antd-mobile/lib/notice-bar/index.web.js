...
var NoticeBar = function (_React$Component) {
    ...
    NoticeBar.prototype.render = function render() {
        ...
        return this.state.show ? _react2["default"].createElement("div", __assign({}, (0, _getDataAttr2["default"])(this.props), { className: wrapCls }, restProps, extraProps), iconDom, _react2["default"].createElement("div", { className: prefixCls + '-content' }, children), operationDom) : null;
    };
