...
var BasicRadioExample = function (_React$Component) {
    ...
    BasicRadioExample.prototype.render = function render() {
        ...
        return _react2["default"].createElement(_reactNative.View, null, _react2["default"].createElement(_reactNative.View, { style: { padding: 10 } }, _react2["default"].createElement(_antdMobile.Radio, { checked: this.state.part1Value === 1, onChange: function onChange(checked) {
                if (checked) {
                    _this2.setState({ part1Value: 1 });
                }
            }, style: { borderWidth: 1, borderColor: '#999', margin: 10 } }), _react2["default"].createElement(_antdMobile.WhiteSpace, null), _react2["default"].createElement(_antdMobile.Radio, { checked: this.state.part1Value === 2, onChange: function onChange(checked) {
                if (checked) {
            ...
            } }, "使用 Ant Desgin Component"), _react2["default"].createElement(RadioItem, { checked: this.state.part2Value === 2, onChange: function onChange(checked) {
                if (checked) {
