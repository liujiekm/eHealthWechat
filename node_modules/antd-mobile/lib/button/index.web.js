...
var Button = function (_React$Component) {
    ...
    Button.prototype.render = function render() {
        ...
        var _splitObject = (0, _splitObject4["default"])(this.props, ['children', 'className', 'prefixCls', 'type', 'size', 'inline', 'disabled', 'htmlType', 'icon', 'loading', 'touchFeedback', 'activeStyle']),
        ...
        var wrapCls = (_wrapCls = {}, (0, _defineProperty3["default"])(_wrapCls, className, className), (0, _defineProperty3["default"])(_wrapCls, prefixCls, true), (0, _defineProperty3["default"])(_wrapCls, prefixCls + '-primary', type === 'primary'), (0, _defineProperty3["default"])(_wrapCls, prefixCls + '-ghost', type === 'ghost'), (0, _defineProperty3["default"])(_wrapCls, prefixCls + '-warning', type === 'warning'), (0, _defineProperty3["default"])(_wrapCls, prefixCls + '-small', size === 'small'), (0, _defineProperty3["default"])(_wrapCls, prefixCls + '-loading', loading), (0, _defineProperty3["default"])(_wrapCls, prefixCls + '-inline', inline), (0, _defineProperty3["default"])(_wrapCls, prefixCls + '-disabled', disabled), _wrapCls);
        ...
        return _react2["default"].createElement("button", __assign({}, restProps, { style: style, type: htmlType || 'button', className: (0, _classnames2["default"])(wrapCls), disabled: disabled }), iconType ? _react2["default"].createElement(_index2["default"], { type: iconType }) : null, kids);
    };
