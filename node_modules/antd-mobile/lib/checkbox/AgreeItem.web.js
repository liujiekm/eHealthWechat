...
var AgreeItem = function (_React$Component) {
    ...
    AgreeItem.prototype.render = function render() {
        ...
        return _react2["default"].createElement("div", __assign({}, (0, _getDataAttr2["default"])(this.props), { className: wrapCls, style: style }), _react2["default"].createElement("label", { className: prefixCls + '-agree-label', htmlFor: name }, _react2["default"].createElement(_Checkbox2["default"], { prefixCls: prefixCls, defaultChecked: defaultChecked, checked: checked, name: name, onChange: onChange, disabled: disabled }), children));
    };
