...
var Result = function (_React$Component) {
    ...
    Result.prototype.render = function render() {
        ...
        return _react2["default"].createElement("div", { className: wrapCls }, _react2["default"].createElement("div", { className: prefixCls + '-pic', style: { backgroundImage: 'url(' + imgUrl + ')' } }), title !== '' ? _react2["default"].createElement("div", { className: prefixCls + '-title' }, title) : null, message !== '' ? _react2["default"].createElement("div", { className: prefixCls + '-message' }, message) : null, buttonText !== '' ? _react2["default"].createElement("div", { className: prefixCls + '-button' }, _react2["default"].createElement(_button2["default"], { type: buttonType, onClick: buttonClick }, buttonText)) : null);
    };
